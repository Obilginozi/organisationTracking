var bildirimSayac = [0,0,0,0];
var bildirimSayacGunluk = [0];
var bildirimSayacHaftalik = [0];
var bildirimSayacAylik = [0];
$(function () {
    "use strict";
    ...
    // chart 5
    $.get('/anasayfa/gelirlerGiderler', function (response) {
        var options = {
            chart: {
                height: 350,
                type: 'area',
    ...
    //     }])
    // });
    $.get('/anasayfa/bildirimSayacAylik', function (response) {
        bildirimSayacAylik[0] = JSON.parse(response);
        console.log(bildirimSayacAylik);
    });
    $.get('/anasayfa/bildirimSayacHaftalik', function (response) {
        bildirimSayacHaftalik[0] = JSON.parse(response);
        console.log(bildirimSayacHaftalik);
    });
    $.get('/anasayfa/bildirimSayacGunluk', function (response) {
        bildirimSayacGunluk[0] = JSON.parse(response);
        console.log(bildirimSayacGunluk);
    });
    // chart 7
    var options = {
        chart: {
    ...
    $.get('/anasayfa/bildirimSayac', function (response) {
        ...
        var options = {
            ...
            colors: ["#8f50ff", "#cddc35", "#f1076f", "#ffd200"],
            series: bildirimSayac,
            labels: ['Toplam', 'Başarılı', 'İptal', 'Hata'],
            responsive: [{
                breakpoint: 1280,
                options: {
                    chart: {
    ...
    // chart 7
    // $.get('/anasayfa/bildirimSayacAylik', function (response) {
        // bildirimSayacAylik.push(JSON.parse(response));
        // console.log("bildirimSayacAylik: " + bildirimSayacAylik);
        // var options = {
        //     chart: {
        //         height: 290,
        //         type: 'radialBar',
    ...
    // chart 8
    // $.get('/anasayfa/bildirimSayacHaftalik', function (response) {
        // bildirimSayacHaftalik.push(JSON.parse(response));
    ...
    // chart 9
    // $.get('/anasayfa/bildirimSayacGunluk', function (response) {
    //     console.log("bildirimSayacGunluk: " + response + "        " + JSON.parse(response))
    //     bildirimSayacGunluk.push(JSON.parse(response));
    //     console.log("bildirimSayacGunluk: "+bildirimSayacGunluk);
    //     var options = {
    //         chart: {
    //             height: 290,
    //             type: 'radialBar',

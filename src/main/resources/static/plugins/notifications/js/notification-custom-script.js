...
function date_msg(titleyuk, msgyuk){
    Lobibox.notify('info', {
        title: titleyuk,
        size: 'mini',
        pauseDelayOnHover: true,
...
function success_noti_drop(title, message) {
    Lobibox.notify('info', {
        title: title,
        pauseDelayOnHover: true,
        continueDelayOnInactiveTab: false,
...
function error_noti_basvuru(titleHata, msg) {
    Lobibox.notify('error', {
        title: titleHata,
        pauseDelayOnHover: true,
        continueDelayOnInactiveTab: false,
...
function error_noti_kimlik() {
    Lobibox.notify('Hata!', {
        pauseDelayOnHover: true,
        continueDelayOnInactiveTab: false,
        position: 'top right',
        icon: 'fa fa-times-circle',
        msg: 'Kimlik bilgileriniz hatalı lütfen kontrol edip tekrar deneyiniz.'
    });
}
...
window.success_noti_yuk = function (msg, status) {
...
function success_noti_custom(msg) {
    Lobibox.notify('success', {
        title: "İşlem Başarılı!",
        pauseDelayOnHover: true,
        continueDelayOnInactiveTab: false,
...
function round_warning_notif(){
    Lobibox.notify('Hata!', {
        ...
        continueDelayOnInactiveTab: false,
        position: 'top right',
        msg: 'Kullanıcı Kaydı Bulunamadı'
    });
}
